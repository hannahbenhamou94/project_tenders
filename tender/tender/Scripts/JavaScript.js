...
$(document).ready(function () {
    ...
    $('#add').click(function () {
        ...
        if ($('#Editors').val() == "0") {
            isAllValid = false;
            $('#Editors').siblings('span.error').css('visibility', 'visible');
        }
        else {
            $('#Editors').siblings('span.error').css('visibility', 'hidden');
        ...
        if (isAllValid) {
            ...
            $('#productCategory,,#Editors,#product,#quantity,#rate,#add', $newRow).removeAttr('id');
            $('span.error', $newRow).remove();
            //append clone row
            $('#orderdetailsItems').append($newRow);

            //clear select data
            $('#productCategory,#Editors,#product').val('0');
            $('#quantity,#rate').val('');
